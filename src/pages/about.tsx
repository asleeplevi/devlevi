      ...
      <div className="w-full max-w-3xl mx-auto relative">
        <section className="w-full h-full bg-main border border-grey rounded-lg p-8 mb-8">
          ...
          <p className="my-2 text-sm">
            ...
            principal para backend, MariaDB para me aprofundar com bancos de
            dados e Linux para entender mais sobre servidores.
          </p>
          <p className="my-2 text-sm">
            Aualmente trabalho em uma startup que atua no setor logístico
            portuário, desenvolvendo sistemas complexos para controle
            operacional de navios. Atuo como desenvolvedor fullstack cuidando
            desde o planejamento da aplicação até o deploy e acompanhamento.
          </p>
          <p className="my-2 text-sm">
            Durante esses anos participei de vários projetos legais como:
            Sistema de descarga de navios, Sistema de chamados, Web Scrappers,
            Lib de componentes React com Material UI, desenvolvimento de
            dashboards BI.
          </p>
          ...
          <p className="text-sm">
            ...
            Prisma;-Implementação de testes unitários e de integração com
            Vitest;
            <br />
            -Trabalhei na otimização de dashboards BI, lidando com grande volume
            de dados;
